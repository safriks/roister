      ...
      <div className="wrapper">
            ...
            <div className="section-story-overview">
              <Row>
                ...
                <Col md="5">
                  ...
                  ></div>
                  <h3>
                  Unlike any other online platform, Roister connects talented people with
                  start-up companies in their earliest stages. 
                  </h3>
                </Col>
              </Row>
            </div>
        ...
        <div className="section section-contact-us text-center">
          <Container>
            ...
            <p className="description">We are currently looking for expertise in various areas of coding and web development. </p>
            <Row>
